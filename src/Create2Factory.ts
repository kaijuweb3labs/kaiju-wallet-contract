...
/**
 * This can be used to deploy a contract to same address on any network.
 * Singleton contracts can be deployed with using this
 */
export class Create2Factory {
  ...
  async deployFactory(signer?: Signer): Promise<void> {
    ...
    console.log(
      "_______________________Deploy Create2Factory_____________________"
    );
